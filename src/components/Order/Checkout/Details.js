...
const Details = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const inputNames = Object.keys(formDetails);
    ...
    inputNames.forEach(name => {
      ...
      if (name === 'postCode') {
        const postCodeCheck = /^([A-Z]{1,2}\d[A-Z\d]? ?\d[A-Z]{2}|GIR ?0A{2})$/.test(formDetails.postCode);
      ...
      if (name === 'email') {
        const emailCheck = /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formDetails.email);
      ...
      <form className="checkout__details--form" onSubmit={handleSubmit} noValidate>
        <div className="form__name">
          <div className="form__first-name form-section">
            ...
            <input type="text" className="form__first-name--input" name="firstName" onChange={handleInputChange} value={formDetails.firstName} />
          ...
          <div className="form__last-name form-section">
            ...
            <input type="text" className="form__last-name--input" name="lastName" onChange={handleInputChange} value={formDetails.lastName}  />
        ...
        <div className="form__city form-section">
          ...
          <input type="text" className="form__city--input" name="city" onChange={handleInputChange} value={formDetails.city}/>
        ...
        <div className="form__address form-section">
          ...
          <input type="text" className="form__address--input" name="address" onChange={handleInputChange} value={formDetails.address} />
        ...
        <div className="form__post-code form-section">
          ...
          <input type="text" className="form__post-code--input" name="postCode" onChange={handleInputChange} value={formDetails.postCode} />
        ...
        <div className="form__phone form-section">
          ...
          <input type="number" className="form__phone--input" name="phone" onChange={handleInputChange} value={formDetails.phone} />
        ...
        <div className="form__email form-section">
          ...
          <input type="email" className="form__email--input" name="email" onChange={handleInputChange} value={formDetails.email}  />
